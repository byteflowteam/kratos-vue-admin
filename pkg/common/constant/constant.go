...
const (
	IpBlackListBan   = 1 //封禁IP黑名单
	IpBlackListUnBan = 2 //解禁IP黑名单
	FreezeAccount    = 0 //冻结帐户
	UnFreezeAccount  = 1 //解冻帐户
	PrivilegedUser   = 1 //特权用户
	OrdinaryUser     = 0 //普通用户
	// 用户可被封禁的行为类型 1=私聊禁言，2=群聊禁言，3=群聊禁言，3=禁止创建群聊，4=禁止登录，5=禁止添加好友，6=冻结帐户
	FriendMuteProhibitedBehavior    = 1 //私聊禁言
	GroupMuteProhibitedBehavior     = 2 //群聊禁言
	CreateGroupProhibitedBehavior   = 3 //禁止创建群聊
	LoginProhibitedBehavior         = 4 //禁止登录
	AddFriendProhibitedBehavior     = 5 //禁止添加好友
	FreezeAccountProhibitedBehavior = 6 //冻结帐户

	BecomeFriendByQRCode = 1 //扫描二维码
	BecomeFriendBySearch = 2 //搜索账号ID
	BecomeFriendByCard   = 3 //名片添加
	BecomeFriendByGroup  = 4 //群聊添加

	SensitiveDefaultLabel = "Normal" //敏感词默认分类
)
